...
from middle.TensorIteratorCondition import DynamicDecoderConditionMatcher
from ops.TensorIterator_ops import TensorIteratorBackEdge, TensorIteratorOutput
...
class BackEdgesMatching(MiddleReplacementPattern):
    ...
    def run_after(self):
        ...
        from middle.TensorIteratorCondition import DynamicDecoderConditionMatcher, LoopConditionMatcher, \
