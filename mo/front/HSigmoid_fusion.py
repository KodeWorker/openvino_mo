...
from front.AttributedClampNormalizer import AttributedClampNormalizer
from ops.activation_ops import HSigmoid
...
from middle.pattern_match import check_value
