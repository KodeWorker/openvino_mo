...
def transform_to_str(value):
    from back.offline_transformations import get_available_transformations   # pylint: disable=no-name-in-module,import-error
...
def get_mo_convert_params():
    mo_convert_docs = convert_model.__doc__
    mo_convert_params = {}
