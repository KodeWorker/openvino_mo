...
from middle.passes.eliminate import mark_output_reachable_nodes, shape_inference, mark_undead_nodes, \
    mark_const_producer_nodes, eliminate_dead_nodes, add_constant_operations
from utils.error import Error
from utils.utils import refer_to_faq_msg, deprecated_api, shrink_str_value
...
class Graph(nx.MultiDiGraph):
    ...
    def erase_node(self, node: Node):
        ...
        if len(outputs) == 0 and len(inputs) != 0:
            from front.extractor import add_output_ops
    ...
    def dump_graph_for_graphviz(self, node_attrs: list = ['kind', 'op', 'shape', 'correct_data_layout', 'nchw_layout',
        ...
        from ops.tensor_iterator import _get_internal_output_node_id, _get_internal_input_node_id
